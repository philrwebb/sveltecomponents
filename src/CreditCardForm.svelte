...
*/
  ...
  function dispatchSavedDataEvent() {
    const event = new CustomEvent("cardData", {
      detail: {
        cardName: cardName,
...
<svelte:options tag="s-creditcard" />
<div class="wrapper" id="app">
  <div class="card-form">
          ...
          <div class="card-item__wrapper">
            ...
            <div class="card-item__content">
              <label
                ...
                {:else}
                  <div class="card-item__name placeholder">Full Name</div>
                {/if}
              </label>
    ...
    <div class="card-form__inner">
        ...
        <div class="card-form__col">
          <div class="card-form__group">
            ...
            <select
              ...
              {#each Array(12) as _, n}
                <option value={n + minCardYear}>{n + minCardYear}</option>
              {/each}
            </select>
          </div>
        </div>
      ...
      <button class="card-form__button" on:click={dispatchSavedDataEvent}>
        Submit
      </button>
    </div>
  </div>
